<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-user"></i> New Group</h3>
            </div>
             <div class="box-body">
...
?>
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Group Code</label>
                  <div class="col-sm-10">
                  <input name="Gcode" type="text" class="form-control" placeholder="Group Code" required>
                  </div>
                  </div>
		...
		<div class="form-group">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Group Manager</label>
                  <div class="col-sm-10">
                  <input name="Gmname" type="text" class="form-control" placeholder="Group Manager" required>
                  </div>
                  </div>

				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Group SubManager</label>
                  <div class="col-sm-10">
                  <input name="Gsmname" type="text" class="form-control" placeholder="Group SubManager" required>
                  </div>
                  </div>
                  ...
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Account Number</label>
                  <div class="col-sm-10">
                  <input name="Accno" type="text" class="form-control" placeholder="Account Number" required>
                  </div>
                  </div>
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900"> Manager Mobile Number</label>
                  <div class="col-sm-10">
                  <input name="Mgphone" type="text" class="form-control" placeholder=" Manager Mobile Number" required>
                  </div>
                  </div>

				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900"> SubManager Mobile Number</label>
                  <div class="col-sm-10">
                  <input name="Smgphone" type="text" class="form-control" placeholder="SubManager Mobile Number" required>
                  </div>
                  </div>
